function [v, f, n, name] = readBinaryStlMesh(fileName)
% READBINARYSTLMESH Read a binary STL file.
% Author: Joey.Chow
% READBINARYSTLMESH reads an STL file written in binary format
%V are the vertices
%F are the faces
%N are the normals
...
[v,f] = removeDuplicateStlVertices(v,f);
