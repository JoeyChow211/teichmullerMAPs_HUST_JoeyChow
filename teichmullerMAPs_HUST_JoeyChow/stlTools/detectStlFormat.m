function format = detectStlFormat(fileName)
% DETECTSTLFORMAT Detect whether an STL file is ASCII or binary.
% Author: Joey.Chow
% DETECTSTLFORMAT identifies the STL format and returns 'binary' or
%'ascii'
